...
if __name__ == "__main__":
    # Health server starts ONCE here — not inside main() to avoid port conflict on retry
    start_health_server()

    # Outer retry loop — if bot crashes, wait 5 seconds and restart automatically
    while True:
        try:
            main()
